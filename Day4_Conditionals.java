public class Day4_Conditionals {
    ...
    of cigars is between 40 and 60, inclusive. Unless it is the weekend, in which case there is no upper bound on 
    ...
    */
    ...
    public static boolean cigarParty(int cigars, boolean isWeekend) {
        if (isWeekend) {
            ...
            return cigars >= 40 && cigars <= 60; // Upper limit applies on weekdays
        }
    }
